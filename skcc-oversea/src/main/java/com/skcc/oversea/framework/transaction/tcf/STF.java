...
import com.skcc.oversea.user.business.facade.*;
import com.skcc.oversea.user.transfer.UserCDTO;
...
import com.skcc.oversea.foundation.utility.CommonUtil;
import com.skcc.oversea.eplatonframework.business.helper.EJBUtils;
import com.skcc.oversea.framework.transaction.dao.TransactionControlDAO;
import com.skcc.oversea.foundation.logej.LOGEJ;
import com.skcc.oversea.framework.transaction.blocking.TXBLXMLconfig;
...
public class STF implements ISTF {
  ...
  public EPlatonEvent execute(EPlatonEvent pevent){
    ...
    try{
      ...
      LOGEJ.getInstance().printf(4,(EPlatonEvent)pevent,"==================[STF_SPinit] start");
      /*
       * 기본적인 정보를 셋팅하는 함수
       * 에러코드를 IZZ000으로 맞춘다
      ...
      switch ( tpsvcinfoDTO.getErrorcode().charAt(0) )
      {
        case 'E' :
           ...
           */
          LOGEJ.getInstance().printf(10,(EPlatonEvent)pevent,"STF_SPinit error");
          LOGEJ.getInstance().printf(10,(EPlatonEvent)pevent,"==================[STF_SPinit] end");
          LOGEJ.getInstance().printf(10,(EPlatonEvent)pevent,"==================[STF_SPend] start");
          STF_SPend();
          LOGEJ.getInstance().printf(10,(EPlatonEvent)pevent,"==================[STF_SPend] end");
          return eplevent;
        case 'I' :
          /* 정상인경우 다음 처리를 위한 준비를 한다
           */
          LOGEJ.getInstance().printf(4,(EPlatonEvent)pevent,"STF_SPinit success");
          LOGEJ.getInstance().printf(4,(EPlatonEvent)pevent,"==================[STF_SPinit] end");
          LOGEJ.getInstance().printf(4,(EPlatonEvent)pevent,"==================[STF_SPmiddle] start");
          STF_SPmiddle();
          LOGEJ.getInstance().printf(4,(EPlatonEvent)pevent,"==================[STF_SPmiddle] end");
          break;
      }
      LOGEJ.getInstance().printf(4,(EPlatonEvent)pevent,"==================[STF_SPend] start");
       ...
       */
      STF_SPend();
      LOGEJ.getInstance().printf(4,(EPlatonEvent)pevent,"==================[STF_SPend] end");
    }
    catch(Exception ex){
      ex.printStackTrace();
      STF_SPerror("EFWK0001",this.getClass().getName()+ ".execute():"+ex.toString());
      LOGEJ.getInstance().eprintf(10,(EPlatonEvent)pevent,ex);
      LOGEJ.getInstance().printf(10,(EPlatonEvent)pevent,"STF.execute:EXCEPTION:"+ex.toString());
    }
  ...
  public boolean STF_SPinit()
  {
    try{
       ...
       * 에러코드정보를 초기화한다.
       ************************************************************************/
      LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"ErrorCode set :: IZZ000");
       ...
       ************************************************************************/
      LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"gitxInfoflag set :: 0");
      giTXInfoflag = 0;
      ...
      */
      ...
      commonDTO.setSystemDate(systemDateAndTime.substring(0, 8));
      LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"System Date set :: "+systemDateAndTime.substring(0, 8));
      ...
      LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"System Time set :: "+systemDateAndTime.substring(0,8));

      /*************************************************************************
       * Base Currency
       ************************************************************************/
      LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"Base Currency set :: 11 ");
      ...
      if( (businessDate=STF_SPgetbusinessdate()) == null ){
        ...
        LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"error to get businessDate");
      }
      else
      ...
      */
      ...
      if( (businessDate = commonManagementSB.getBusinessDate("11")) == null ){
        ...
        LOGEJ.getInstance().printf(10,(EPlatonEvent)eplevent,"STF_SPinit()::get business date error");
      }
      else
        commonDTO.setBusinessDate(businessDate);

      LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"Business Date :: "+businessDate);
  ...
  public boolean STF_SPmiddle()
  {
    try{
       ...
       ************************************************************************/
      LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"Get Transaction Level::");
      ...
      if( ! "usertransaction".equals(transaction_type) ){
        ...
        tpinfomode = TPMSVCAPI.getInstance().TPinfo(tx);
      }
      ...
      switch (tpinfomode)
      {
        ...
        case 0 :
           ...
           *
           ********************************************************************/
          LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"Transaction Level       : [Already Transaction started]" );
          LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"Transaction TPinfo mode : [" + tpinfomode +"]" );
          ...
          if( !"usertransaction".equals(transaction_type) )
          {
            if( !tpsvcinfoDTO.getTpfq().equals("100") ){
              if( TPMSVCAPI.getInstance().TPbegin(tpsvcinfoDTO.getTx_timer()) ){
                setSTF_SPtxinfo(1);
                LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"TPbegin() 성공" );
              }
              else{
                STF_SPerror("EFWK0007",this.getClass().getName()+ ".STF_SPmiddle()::TPbegin()시에 에러발생");
                LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"TPbegin() 실패" );
              }
            }
          }
        ...
        case 1 : //Marked Rollback
          ...
          LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"TPinfo() Marked Rollback " );
          break;
        case 6 :
          /*********************************************************************
           ...
           ********************************************************************/
          LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"Transaction Level       : [Not started]" );
          LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"Transaction TPinfo mode : [" + tpinfomode +"]" );

          if( !"usertransaction".equals(transaction_type) )
          {
            LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"Transaction type      : [container]" );
            if( TPMSVCAPI.getInstance().TPbegin(tpsvcinfoDTO.getTx_timer()) ){
              setSTF_SPtxinfo(1);
              LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"TPbegin() 성공" );
            }
            ...
            LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"Transaction type      : [bean]" );
            if( TPMSVCAPI.getInstance().TPbegin(tx,CommonUtil.Str2Int(tpsvcinfoDTO.getTx_timer()))){
              LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"TPbegin() 성공" );
              setSTF_SPtxinfo(1);
            }
            else{
          ...
          LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"Transaction TPbegin mode       : [" + this.giTXInfoflag + "]" );
          break;
        default:
          STF_SPerror("EFWK0010","TPinfo() Nothing ");
          LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"TPinfo() Marked Nothing " );
          break;
      }
      ...
      LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"HOSTSEQ:" + tpsvcinfoDTO.getHostseq()  + " ORGSEQ:"+tpsvcinfoDTO.getOrgseq() );
      ...
      STF_SPeod();
      LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"[" + tpsvcinfoDTO.getTrclass() + "]"  );
      if( isErr() ){
        return false;
      }
       ...
       * 배치 거래만 허용
       ************************************************************************/
       LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"Set Control Transaction ::");
       //STF_SPtxctl();
       STF_SPtxblocking();
       if( isErr() ){
         return false;
        ...
        * 800 - 인터넷뱅킹에서 호출
        ************************************************************************/
       LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"Check Call Transaction Location :: ");
       switch( CommonUtil.Str2Int(tpsvcinfoDTO.getTpfq()) )
       {
         case 100 :
           LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"TPFQ : 100 ");
           break;
         case 200 :
           LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"TPFQ : 200 ");
           break;
         case 300 :
           LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"TPFQ : 300 ");
           break;
         case 400 :
           LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"TPFQ : 400 ");
           break;
         default :
           LOGEJ.getInstance().printf(10,(EPlatonEvent)eplevent,"TPFQ : not valid ");
           STF_SPerror("EFWK0007",this.getClass().getName()+ ".STF_SPmiddle():TPFQ NOT VALID");
         break;
       }
       LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"클라이언트의 호출위치 정보를 가지고 온다 : [" + tpsvcinfoDTO.getTpfq() + "]"  );
       if( isErr() ){
         return false;
       }
      ...
      LOGEJ.getInstance().printf(10,(EPlatonEvent)eplevent,".STF_SPmiddle():"+ex.toString());
      LOGEJ.getInstance().eprintf(10,(EPlatonEvent)eplevent,ex);
  ...
  public boolean STF_SPend()
  {
    try{
       ...
       * 기본정보를 재셋팅한다.
       ************************************************************************/
      LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"Set SystemOuttime ::");
       ...
       * 패킷정보를 재셋팅한다.
       ************************************************************************/
      LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"Move Packet Rebuild ::");
      STF_SPmovepacket();
      ...
      if( this.eplevent.getTPSVCINFODTO().getErrorcode().charAt(0) != 'E' ){
        ...
        LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"==================[STF_SPdbInLog() START]");
        if( !STF_SPdbInLog(eplevent) ){
          LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"STF_SPdbInLog() error");
        }
        else{
          LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"STF_SPdbInLog() success");
        }
        LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"==================[STF_SPdbInLog() END] (true)");
       ...
       * 공통정보 로깅작을 실시한다.
       ************************************************************************/
      LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"==================[STF_SPcommonLog START]");
      if( !STF_SPcommonLog() ){
        LOGEJ.getInstance().printf(10,(EPlatonEvent)eplevent,"STF_SPcommonLog() error");
      }
      else{
        LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"STF_SPcommonLog() success");
      }
      LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"==================[STF_SPcommonLog() END] (true)");
...
grant select,insert,update,delete on TRANSACTION_UPDOWN to eplaton;
  ...
  private  boolean STF_SPcommonLog() {
    ...
    try {
       ...
       ************************************************************************/
      LOGFILENAME = com.kdb.oversea.framework.transaction.constant.TCFConstants.INPUT_LOGFILENAME  + CommonUtil.GetHostName() + "." +
  ...
  private int STF_SPtxctl()
  {
    ...
    try{
       ...
       */
      LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"모든 온라인거래에 대한 제어 여부를 판별한다");

      /*
       * 모든 배치거래에 대한 제어 여부를 판별한다
       */
      LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"모든 배치거래에 대한 제어 여부를 판별한다");

      /*
       * ATM 거래에 대한 제어여부를 관리한다
       */
      LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"ATM 거래에 대한 제어여부를 관리한다");

      /*
       * 인터넷뱅 거래에 대한 제어여부를 관리한다
       */
      LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"인터넷뱅 거래에 대한 제어여부를 관리한다");
       ...
       * ....
       */
      LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"거래코드에 대한 제어여부를 관리한다");

      /*
       * 뱅크코드에 대한 텔러별 제어 정보를 관리한다
       */

      LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"뱅크코드에 대한 텔러별 제어 정보를 관리한다");
          ...
          && CommonUtil.CHECKisdigit(count_value,count_value.length())  )
      {
        for( int i = 1 ; i <= CommonUtil.atoi(count_value) ; i++ )
        {
          ...
          if( ctxcode >= sv && ctxcode <= ev ){
            ...
            LOGEJ.getInstance().printf(10,this.eplevent,"Transaction Block -- txcode ");
            return true;
          }
        }
      }
          ...
          && CommonUtil.CHECKisdigit(count_value,count_value.length())  )
      {
        for( int i = 1 ; i <= CommonUtil.atoi(count_value) ; i++ )
        {
          ...
          if( val.equals(system) ){
            ...
            LOGEJ.getInstance().printf(10,this.eplevent,"Transaction Block -- system ");
            return true;
          }
          ...
          && CommonUtil.CHECKisdigit(count_value,count_value.length())  )
      {
        for( int i = 1 ; i <= CommonUtil.atoi(count_value) ; i++ )
        {
          ...
          if( cbankcode >= sv && cbankcode <= ev ){
            ...
            LOGEJ.getInstance().printf(10,this.eplevent,"Transaction Block -- Bank ");
            return true;
          }
        }
      }
          ...
          && CommonUtil.CHECKisdigit(count_value,count_value.length())  )
      {
        for( int i = 1 ; i <= CommonUtil.atoi(count_value) ; i++ )
        {
          ...
          if( ctpfq >= sv && ctpfq <= ev ){
            STF_SPerror("EFWK0011","STF_SPbankcodeblock():해당뱅크는 거래안됨");
            LOGEJ.getInstance().printf(10,this.eplevent,"Transaction Block -- tpfq ");
            return true;
          }
        }
      }
