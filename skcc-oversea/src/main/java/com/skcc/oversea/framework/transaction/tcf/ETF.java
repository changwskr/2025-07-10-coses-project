...
import com.skcc.oversea.framework.transaction.tpmutil.*;
...
public class ETF implements IETF {
  ...
  public EPlatonEvent execute(EPlatonEvent pevent){
    try{
      ...
      LOGEJ.getInstance().printf(10,(EPlatonEvent)eplevent,":*** Biz return errorcode *** [" + pevent.getTPSVCINFODTO().getErrorcode() +"]"  );
