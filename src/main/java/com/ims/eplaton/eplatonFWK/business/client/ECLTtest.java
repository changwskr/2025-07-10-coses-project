package com.ims.eplaton.eplatonFWK.business.client;
...
public class ECLTtest {
  ...
  public EPlatonEvent doSTF(EPlatonEvent event)
  {
    ...
    try{
      ...
      commonDTO.setReqName("com.ims.eplaton.eplatonFWK.business.delegate.action.CashCardBizAction");
      ...
      switch( resevent.getTPSVCINFODTO().getErrorcode().charAt(0) )
      {
        ...
        case 'I':
          resevent = (EPlatonEvent)tpcsendrecv.callEJB("CashCard",
              "CashCardBizAction",
              "com.ims.eplaton.eplatonFWK.othersystem.operation.COMMO1000",
              event);
          break;
      }
