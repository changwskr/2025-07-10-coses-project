...
public class TCF extends AbstractTCF implements ITCF
{
  ...
  public EPlatonEvent execute(EPlatonEvent pevent){
    try {
      ...
      LOGEJ.getInstance().printf(1,(EPlatonEvent)pevent,"====================================================================[TCF] start");
      ...
      if( tx == null ){
        ...
        LOGEJ.getInstance().printf(1,(EPlatonEvent)pevent,"====================================================================[TCF] end");
        return eplevent;
      }
       ...
       * STF 시작한다.
       */
      LOGEJ.getInstance().printf(1,(EPlatonEvent)pevent,"====================================================[STF] start");
      ...
      switch( eplevent.getTPSVCINFODTO().getErrorcode().charAt(0) )
      {
        ...
        case 'E':
        case 'S':
          LOGEJ.getInstance().printf(1,(EPlatonEvent)pevent,"===============================[STF] error");
          LOGEJ.getInstance().printf(1,(EPlatonEvent)pevent,"====================================================[STF] end");
          break;
        case 'I':
          LOGEJ.getInstance().printf(1,(EPlatonEvent)pevent,"===============================[STF] success");
          LOGEJ.getInstance().printf(1,(EPlatonEvent)pevent,"====================================================[STF] end");
          LOGEJ.getInstance().printf(1,(EPlatonEvent)pevent,"====================================================[BTF] start");
           ...
           */
          if( isErr() )
            LOGEJ.getInstance().printf(1,(EPlatonEvent)pevent,"===============================[BTF] error");
          else
            LOGEJ.getInstance().printf(1,(EPlatonEvent)pevent,"===============================[BTF] success");


          LOGEJ.getInstance().printf(1,(EPlatonEvent)pevent,"====================================================[BTF] end");
          break;
        case '*':
        default:
       ...
       * 트랜잭션을 종료한다.
       */
      LOGEJ.getInstance().printf(1,(EPlatonEvent)pevent,"====================================================[ETF] start");
      ...
      LOGEJ.getInstance().printf(1,(EPlatonEvent)pevent,"====================================================[ETF] end");
