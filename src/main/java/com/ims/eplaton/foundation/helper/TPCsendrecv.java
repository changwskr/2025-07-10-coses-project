...
import com.ims.eplaton.eplatonFWK.business.EPlatonBizDelegateSB;
import com.ims.eplaton.eplatonFWK.business.EPlatonBizDelegateSBHome;
import com.ims.eplaton.eplatonFWK.business.EPlatonBizDelegateSBBean;
import com.ims.eplaton.eplatonFWK.transfer.EPlatonCommonDTO;
import com.ims.eplaton.eplatonFWK.transfer.EPlatonEvent;
import com.ims.eplaton.eplatonFWK.transfer.TPSVCINFODTO;
...
public class TPCsendrecv {
      ...
      throws IOException
  {
    ...
    try {
      ...
      //ST.4-BTF.execute()에서 operation클래스 인스턴스화이후 invoke할 메소드명
      String CallOperationClasssMethod = tpsvcinfoDTO.getOperation_method();
