package com.ims.eplaton.eplatonFKC.othersystem.operation;
...
import com.ims.eplaton.eplatonFKC.business.operation.IBizOperation;
...
public class COMMO1000 implements IBizOperation
{
  public EPlatonEvent act(EPlatonEvent event)
  {
    ...
    try{
      LOGEJ.getInstance().printf(1,(EPlatonEvent)event,"==================[COMO1000 START]");
      ...
      tpmcommonDTO.setReqName("com.ims.eplaton.eplatonFKC.business.delegate.action.DepositBizAction");
      ...
      */
      ...
      tpmtpsvcinfo.setAction_name("com.ims.eplaton.eplatonFKC.business.delegate.action.CashCardBizAction");
      //Operation_name=::옛날시스템의 Facade단의 세션빈을을 제거한 클래명이다
      //Operation_method=::operation_name(실제클래스명)의 호출메소드명을 말한다.
      tpmtpsvcinfo.setOperation_name("com.ims.eplaton.eplatonFKC.othersystem.operation.DED0021000");
      ...
      tpmevent = TPMSVCAPI.getInstance().TPSsendrecv("CashCard","Deposit",
          "com.ims.eplaton.eplatonFKC.business.delegate.action.DepositBizAction",
          "com.ims.eplaton.eplatonFKC.othersystem.operation.DED0021000",
          event,tpmevent);
    ...
    LOGEJ.getInstance().printf(1,(EPlatonEvent)event,"==================[COMO1000  END]"+event.getTPSVCINFODTO().getSystem_name()  );
    return event;
