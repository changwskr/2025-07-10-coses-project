...
2) xml 파일 구성 및 추가
   <cashCard-listCashCard>
        ...
        * 추가<operation-class>com.ims.oversea.cashCard.business.facade.CashCardManageMent</operation-class>
  </cashCard-listCashCard>
...
CREATE TABLE TRANSACTION_INFO(
        ...
        stf_intime               VARCHAR2(100)  ,
        stf_outtime              VARCHAR2(100)  ,
        stf_interval             VARCHAR2(100)  ,

        btf_intime               VARCHAR2(100)  ,
        btf_outtime              VARCHAR2(100)  ,
        btf_interval             VARCHAR2(100)  ,

        etf_intime               VARCHAR2(100)  ,
        etf_outtime              VARCHAR2(100)  ,
        etf_interval             VARCHAR2(100)  ,
        CONSTRAINT PK_TRANSACTION_INFO PRIMARY KEY (transaction_id,bankcode)
        USING INDEX TABLESPACE TSP_CORE_IND
)
TABLESPACE TSP_CORE
/
