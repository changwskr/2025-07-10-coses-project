...
public class SPcommoManagementSBBean extends com.chb.coses.framework.business.AbstractSessionBean
    implements  SessionBean
{
  ...
  public EPlatonEvent execute(EPlatonEvent event)
  {
    ...
    catch (Exception re)
    {
      ...
      LOGEJ.getInstance().printf(TCFConstants.GENERAL_LOG_LEVEL,resp_event,this.getClass().getName()+ ".execute():" + re.toString());
  ...
  public EPlatonEvent notxexecute(EPlatonEvent event) {
    /**@todo Complete this method*/
