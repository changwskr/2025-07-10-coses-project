...
import com.kdb.oversea.framework.transaction.delegate.action.*;
...
public class TPSsendrecv {
                                  ...
                                  )
  {
    ...
    try{
      ...
      LOGEJ.getInstance().printf(6,oevent,"==================[TPSsendrecv() START]");
      LOGEJ.getInstance().printf(6,oevent,"SYSTEM         :"+systemName);
      LOGEJ.getInstance().printf(6,oevent,"actionClassName:"+actionClassName);
      LOGEJ.getInstance().printf(6,oevent,"operationName  :"+operationName);
      LOGEJ.getInstance().printf(6,oevent,"operationMethod  :"+operationMethod);
      LOGEJ.getInstance().printf(6,oevent,"TPM(SEND)-"+com.chb.coses.foundation.utility.Reflector.objectToString(request_event));
    ...
    //////////////////////////////////////////////////////////////////////////
    {
      ...
      {
        case 'I' :
          LOGEJ.getInstance().printf(6,oevent,"TPM(RECV)-"+com.chb.coses.foundation.utility.Reflector.objectToString(reponse_event));
          LOGEJ.getInstance().printf(6,oevent,"TPSsendrecv() Call Success");
          break;
        case 'E' :
          LOGEJ.getInstance().printf(6,oevent,"TPM(RECV)-"+com.chb.coses.foundation.utility.Reflector.objectToString(reponse_event));
          LOGEJ.getInstance().printf(6,oevent,"TPSsendrecv() Call Fail [" + reponse_tpsvcinfoDTO.getErrorcode() + "]" );
          break;
      }
    }

    LOGEJ.getInstance().printf(6,oevent,"==================[TPSsendrecv() END]");
