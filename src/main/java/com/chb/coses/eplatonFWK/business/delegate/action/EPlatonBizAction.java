...
import com.chb.coses.eplatonFWK.business.facade.deposit.*;
...
public abstract class EPlatonBizAction  implements IEPlatonBizAction
{
  ...
  protected IEvent doAct(Object target, IEvent event)
  {
    ...
    String parameterTypeName = "com.chb.coses.eplatonFWK.transfer.EPlatonEvent" ;
    ...
    try
    {
      if( !tpsvcinfo.getTpfq().equals("200") ){
        //EPlatonBizDelegate을 통하지 않고 서버끼리의 호출시
