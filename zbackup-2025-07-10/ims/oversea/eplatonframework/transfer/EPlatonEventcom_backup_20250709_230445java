...
public final class EPlatonEvent implements IEvent
{
    ...
    private EPLmessageParameter messageParameter;
    /**
     * 기본 생성자.
     */
    public EPlatonEvent()
    {
      ...
      this.messageParameter = new EPLmessageParameter();
    }
  ...
  public EPLmessageParameter getMessageParameter() {
    return messageParameter;
  }
  public void setMessageParameter(EPLmessageParameter messageParameter) {
