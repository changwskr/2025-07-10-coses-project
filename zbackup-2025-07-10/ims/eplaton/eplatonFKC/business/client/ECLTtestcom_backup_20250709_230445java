package com.ims.eplaton.eplatonFKC.business.client;
...
import com.ims.eplaton.foundation.helper.TPCsendrecv;
...
public class ECLTtest {
  ...
  public EPlatonEvent doSTF(EPlatonEvent event)
  {
    ...
    try{
      ...
      commonDTO.setReqName("com.ims.eplaton.eplatonFKC.business.delegate.action.CashCardBizAction");
      commonDTO.setgetIPAddress("172.21.111.110");

      tpsvcinfo.setSystem_name("CashCard");
      tpsvcinfo.setAction_name("com.ims.eplaton.eplatonFKC.business.delegate.action.CashCardBizAction");
      tpsvcinfo.setOperation_name("com.ims.eplaton.eplatonFKC.othersystem.operation.COMMO1000");
      ...
      switch( resevent.getTPSVCINFODTO().getErrorcode().charAt(0) )
      {
        ...
        case 'I':
          resevent = (EPlatonEvent)tpcsendrecv.callEJB("CashCard",
              "CashCardBizAction",
              "com.ims.eplaton.eplatonFKC.othersystem.operation.COMMO1000",
              event);
          break;
      }
