package com.ims.eplaton.framework.transaction.container.tcf;
...
import com.ims.eplaton.foundation.helper.CommonUtil;
import com.ims.eplaton.eplatonFWK.business.dao.*;
...
public class TCF extends AbstractTCF implements ITCF
{
      ...
      EPlatonEvent peplaton_event,SessionContext session_context,String transaction_mode)
  {
    try {
      ...
      LOGEJ.getInstance().printf(1,(EPlatonEvent)peplaton_event,
                                 "====================================================================[TCF] start");
      ...
      if( "usertransaction".equals(transaction_type) )
      {
         ...
         */
        LOGEJ.getInstance().printf(1,(EPlatonEvent)peplaton_event,"[UserTransaction Start]");
        ...
        if( tx == null ){
          ...
          LOGEJ.getInstance().printf(1,(EPlatonEvent)peplaton_event,"UserTransaction Errror");
          LOGEJ.getInstance().printf(1,(EPlatonEvent)peplaton_event,"[UserTransaction End]");
          LOGEJ.getInstance().printf(1,(EPlatonEvent)peplaton_event,
                                     "====================================================================[TCF] end");
          return eplevent;
        }
        LOGEJ.getInstance().printf(1,(EPlatonEvent)peplaton_event,"UserTransaction Success");
        LOGEJ.getInstance().printf(1,(EPlatonEvent)peplaton_event,"[UserTransaction END]");
      }
      else{
        LOGEJ.getInstance().printf(1,(EPlatonEvent)peplaton_event,"[Container Transaction Start]");
      }
      ...
      if( "usertransaction".equals(transaction_type) )
      {
        ...
        eplevent = (stf=new STF(transaction_type)).execute(eplevent);
      }
      ...
      if( "usertransaction".equals(transaction_type) ){
        LOGEJ.getInstance().printf(1,(EPlatonEvent)peplaton_event,"UserTransactionInfo : " + tx);
        eplevent = (etf=new ETF(tx,stf.getSTF_SPtxinfo())).execute(eplevent);
      }
      else{
        LOGEJ.getInstance().printf(1,(EPlatonEvent)peplaton_event,"TransactionInfo : " + tx);
      ...
      LOGEJ.getInstance().printf(1,(EPlatonEvent)peplaton_event,"TCF_execute() exception:[EFWK032]");
  ...
  public EPlatonEvent execute_sample(EPlatonEvent pevent,SessionContext session_context,String transaction_mode)
  {
    ...
    {
      eplevent = pevent;
      this.ctx = session_context;

      LOGEJ.getInstance().printf(1,(EPlatonEvent)pevent,
                                 "====================================================================[TCF] start");
      ...
      if( "usertransaction".equals(transaction_mode) ){
        ...
        LOGEJ.getInstance().printf(1,(EPlatonEvent)pevent,"TCF_execute() exception:[EFWKW01]");
      }
    }
    catch(Exception ex){
      TCF_SPerror("EFWK0W02",this.getClass().getName()+ ".execute():"+ex.toString());
      LOGEJ.getInstance().printf(1,(EPlatonEvent)pevent,"TCF_execute() exception:[EFWKW02]");
      LOGEJ.getInstance().eprintf(5,(EPlatonEvent)eplevent,ex);
    }
  ...
  public EPlatonEvent usertransaction_execute(EPlatonEvent pevent){
    try {
       ...
       * UserTransaction에 대한 정보를 구하고 시작한다.
       */
      LOGEJ.getInstance().printf(1,(EPlatonEvent)pevent,"[UserTransaction Start]");
      tx = TPMSVCAPI.getInstance().TPJNDIUserTransaction(this.url);
      if( tx == null ){
        eplevent.getTPSVCINFODTO().setErrorcode("IZZ000");
        TCF_SPerror("EBD100","UserTransaction Get Ex");
        LOGEJ.getInstance().printf(1,(EPlatonEvent)pevent,"UserTransaction Errror");
        LOGEJ.getInstance().printf(1,(EPlatonEvent)pevent,"[UserTransaction End]");
        LOGEJ.getInstance().printf(1,(EPlatonEvent)pevent,
                                   "====================================================================[TCF] end");
        return eplevent;
      }
      LOGEJ.getInstance().printf(1,(EPlatonEvent)pevent,"UserTransaction Success");
      LOGEJ.getInstance().printf(1,(EPlatonEvent)pevent,"[UserTransaction END]");
      ...
      LOGEJ.getInstance().printf(1,(EPlatonEvent)pevent,
                                 "====================================================[ETF] start");
      LOGEJ.getInstance().printf(1,(EPlatonEvent)pevent,"UserTransactionInfo : " + tx);
      level("Before","ETF");
      eplevent = (etf=new ETF(tx,stf.getSTF_SPtxinfo())).execute(eplevent);
      LOGEJ.getInstance().printf(1,(EPlatonEvent)pevent,
                                 "====================================================[ETF] end");
      ...
      TCF_SPerror("EFWK0032",this.getClass().getName()+ ".execute():"+ex.toString());
      LOGEJ.getInstance().printf(1,(EPlatonEvent)pevent,"TCF_execute() exception:[EFWK032]");
      LOGEJ.getInstance().eprintf(5,(EPlatonEvent)eplevent,ex);
    }
  ...
  public EPlatonEvent containertransaction_execute(EPlatonEvent pevent){
    try {
      ...
      LOGEJ.getInstance().printf(1,(EPlatonEvent)pevent,
                                 "====================================================[STF] start");
      eplevent = (stf=new STF("container")).execute(eplevent);
