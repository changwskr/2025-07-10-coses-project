...
public class TCF extends AbstractTCF implements ITCF
{
      ...
      EPlatonEvent peplaton_event,SessionContext session_context,String transaction_mode)
  {
    try {
      ...
      LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"Transaction TPinfo mode : [" + TxHelper.status2String(tm.getStatus()) +"] tpfq:[" +this.eplevent.getTPSVCINFODTO().getTpfq()+"]"  );
      ...
      * 트랜잭션을 시작한다
      ...
      else if( "no_transaction_type".equals(transaction_type) )
      {
        ...
        LOGEJ.getInstance().printf(5,(EPlatonEvent)peplaton_event,"bean no_transaction_type value");
        LOGEJ.getInstance().printf(5,(EPlatonEvent)peplaton_event,
                                   "====================================================================[TCF] end");
        return eplevent;
      }
      ...
      LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"222Transaction TPinfo mode : [" + TxHelper.status2String(tm.getStatus()) +"] tpfq:[" +this.eplevent.getTPSVCINFODTO().getTpfq()+"]"  );
      /*
      * STF 시작한다.
       */
      LOGEJ.getInstance().printf(5,(EPlatonEvent)peplaton_event,
      ...
      LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"33333Transaction TPinfo mode : [" + TxHelper.status2String(tm.getStatus()) +"] tpfq:[" +this.eplevent.getTPSVCINFODTO().getTpfq()+"]"  );
      /*
      * STF 을 종료한다.
       */
      level("After","STF");
