...
public class STF implements ISTF {
    ...
    try{
      ...
      switch ( tpsvcinfoDTO.getErrorcode().charAt(0) )
      {
        case 'E' :
           ...
           */
          LOGEJ.getInstance().printf(4,(EPlatonEvent)pevent,"STF_SPinit error");
      ...
      LOGEJ.getInstance().printf(4,(EPlatonEvent)pevent,"STF.execute:EXCEPTION:"+ex.toString());
    }
    ...
    try{
      ...
      */
      ...
      if( (businessDate = commonManagementSB.getBusinessDate("11")) == null ){
        ...
        LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"STF_SPinit()::get business date error");
      }
      else
        commonDTO.setBusinessDate(businessDate);
       ...
       ************************************************************************/
       ...
       switch( CommonUtil.Str2Int(tpsvcinfoDTO.getTpfq()) )
       {
         ...
         case 400 :
           ...
           break;
         default :
           LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"TPFQ : not valid ");
  ...
  public boolean STF_SPend()
  {
    try{
      ...
      if( !STF_SPcommonLog() ){
        LOGEJ.getInstance().printf(4,(EPlatonEvent)eplevent,"STF_SPcommonLog() error");
      }
      else{
          ...
          && CommonUtil.CHECKisdigit(count_value,count_value.length())  )
      {
        for( int i = 1 ; i <= CommonUtil.atoi(count_value) ; i++ )
        {
          ...
          if( ctxcode >= sv && ctxcode <= ev ){
            ...
            LOGEJ.getInstance().printf(4,this.eplevent,"Transaction Block -- txcode ");
            return true;
          }
        }
      }
          ...
          && CommonUtil.CHECKisdigit(count_value,count_value.length())  )
      {
        for( int i = 1 ; i <= CommonUtil.atoi(count_value) ; i++ )
        {
          ...
          if( val.equals(system) ){
            ...
            LOGEJ.getInstance().printf(4,this.eplevent,"Transaction Block -- system ");
            return true;
          }
          ...
          && CommonUtil.CHECKisdigit(count_value,count_value.length())  )
      {
        for( int i = 1 ; i <= CommonUtil.atoi(count_value) ; i++ )
        {
          ...
          if( cbankcode >= sv && cbankcode <= ev ){
            ...
            LOGEJ.getInstance().printf(4,this.eplevent,"Transaction Block -- Bank ");
            return true;
          }
        }
      }
          ...
          && CommonUtil.CHECKisdigit(count_value,count_value.length())  )
      {
        for( int i = 1 ; i <= CommonUtil.atoi(count_value) ; i++ )
        {
          ...
          if( ctpfq >= sv && ctpfq <= ev ){
            STF_SPerror("EFWK0011","STF_SPbankcodeblock():해당뱅크는 거래안됨");
            LOGEJ.getInstance().printf(4,this.eplevent,"Transaction Block -- tpfq ");
            return true;
          }
        }
      }
