package com.kdb.oversea.eplatonframework.business;
...
import com.kdb.oversea.foundation.config.*;
    ...
    implements IBizDelegate, SessionBean
{
  ...
  public IEvent execute(IEvent event) throws BizDelegateException {
    ...
    try
    {
      ...
      if ( !isErr((EPlatonEvent)event) )
      {
        ...
        /*
         * ACTION 클래스를 가지고 온다
         * actionClassName="com.kdb.oversea.eplatonframework.business.delegate.action.CashCardBizAction"
    ...
    TPMSVCAPI.getInstance().TPSsend((EPlatonEvent)resevent);
  ...
  public com.kdb.oversea.eplatonframework.transfer.EPlatonEvent epl_method_01(EPlatonEvent event, String s1) {
