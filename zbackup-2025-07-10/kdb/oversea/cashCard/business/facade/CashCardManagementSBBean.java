...
import com.kdb.oversea.cashCard.business.cashCardRule.*;
import com.kdb.oversea.cashCard.business.constants.CashCardConstants;
import com.kdb.oversea.cashCard.business.constants.CashCardErrorConstants;
import com.kdb.oversea.cashCard.business.facade.helper.*;
import com.kdb.oversea.cashCard.business.cashCard.model.*;
import com.kdb.oversea.cashCard.business.facade.dao.ICashCardDAO;
import com.kdb.oversea.cashCard.business.facade.dao.CashCardDAOFactory;
 ...
 * cashCard.xml 파일형식
 *
<cashCard-callmethod01>
        <bizaction-class>com.kdb.oversea.eplatonframework.business.delegate.action.CashCardBizAction</bizaction-class>
        ...
        <bizaction-parametertype>com.chb.coses.cashCard.transfer.CashCardCDTO</bizaction-parametertype>
</cashCard-callmethod01>

<cashCard-callmethod02>
        <bizaction-class>com.kdb.oversea.eplatonframework.business.delegate.action.CashCardBizAction</bizaction-class>
        <transactionable>Y</transactionable>
        <bizaction-method>callmethod02</bizaction-method>
        <operation-class>com.kdb.oversea.cashCard.business.facade.CashCardManagementSBBean</operation-class>
        <bizaction-parametertype>com.chb.coses.cashCard.transfer.CashCardCDTO</bizaction-parametertype>
</cashCard-callmethod02>
 *
...
//========================    Private Method Area     ========================//
        ...
        throws CosesAppException
    {
      ...
      LOGEJ.getInstance().printf(1,(EPlatonEvent)eplatonevent,"==================[callmethod01 START]");

      commonDTO = (EPlatonCommonDTO)eplatonevent.getCommon();
      tpsvcinfo = eplatonevent.getTPSVCINFODTO();

      reqcdto = (EPLcommonCDTO)eplatonevent.getRequest();
      ...
      reqcdto.setAccountNumber("8888888888888888");
      eplatonevent.setResponse(reqcdto);
      LOGEJ.getInstance().printf(1,(EPlatonEvent)eplatonevent,"==================[callmethod01  END]");
      ...
      /**
       * 에러를 강제로 배출하여 fwk 에러상황을 조사하는 경우에 이용
       */
        ...
        throws CosesAppException
    {
      ...
      LOGEJ.getInstance().printf(1,(EPlatonEvent)eplatonevent,"==================[callmethod02 START]");

      commonDTO = (EPlatonCommonDTO)eplatonevent.getCommon();
      tpsvcinfo = eplatonevent.getTPSVCINFODTO();
      rescdto = (EPLcommonCDTO)eplatonevent.getRequest();
      ...
      eplatonevent.setResponse(reqcdto);
      LOGEJ.getInstance().printf(1,(EPlatonEvent)eplatonevent,"==================[callmethod02  END]");
      return eplatonevent;
    }
