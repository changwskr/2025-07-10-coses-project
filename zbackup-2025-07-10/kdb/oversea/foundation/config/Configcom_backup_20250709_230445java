package com.kdb.oversea.foundation.config;
...
public class Config
{
  private static final String CONFIG_FILE_NAME = "/weblogic/bea/wlserver6.1/config/coses_US/applicationConfig/EPLconfig.xml";
