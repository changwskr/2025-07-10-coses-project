...
import com.kdb.oversea.foundation.tpmservice.TPMSVCAPI;
import com.kdb.oversea.eplatonframework.business.constants.BusinessDelegateConstants;
...
public abstract class EPlatonBizAction  implements IEPlatonBizAction
{
  ...
  protected IEvent doAct(Object target, IEvent event)
  {
    ...
    String methodName = BusinessDelegateConstants.BIZDELEGATE_CALL_METHOD_NAME ;
    String parameterTypeName = BusinessDelegateConstants.BIZDELEGATE_CALL_PARAMETER_TYPE_NAME;
