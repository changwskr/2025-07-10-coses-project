package com.ims.oversea.common.business.thing;
...
public class CommonSBBean extends AbstractBIZBCF
{

  public IDTO entitycallmethod01(IDTO hotCardDDTO) throws CosesAppException
  {
    printf(1,"CommonSBBean call start =====================");


    printf(1,"CommonSBBean call end =======================");
