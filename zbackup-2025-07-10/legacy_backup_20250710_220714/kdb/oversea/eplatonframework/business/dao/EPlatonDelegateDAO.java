...
import com.kdb.oversea.eplatonframework.business.model.TransactionLogDDTO;
import com.kdb.oversea.eplatonframework.business.dao.TransactionLogEntity;
...
public class EPlatonDelegateDAO extends AbstractDAO implements IEPlatonDelegateDAO
{
    public boolean DB_INSERTinlog(EPlatonEvent event)
    {
        ...
        try {
            ...
            com.kdb.oversea.framework.transaction.model.TransactionLogDDTO logDDTO = (com.kdb.oversea.framework.transaction.model.TransactionLogDDTO)converter.getTransactionLogDDTO(event);
            ...
            new com.kdb.oversea.framework.transaction.dao.TransactionLogEntity(event).insertTransactionInLog(
                                                        con                        ,
