package com.chb.coses.eplatonFMK.business.clt;
...
import com.chb.coses.eplatonFMK.business.helper.TPCsendrecv;
...
public class ECLTcommon {
  ...
  public EPlatonEvent doSTF(EPlatonEvent event)
  {
    ...
    try{
      ...
      commonDTO.setReqName("com.chb.coses.eplatonFMK.business.delegate.action.CashCardBizAction");
      commonDTO.setgetIPAddress("172.21.111.110");

      tpsvcinfo.setSystem_name("CashCard");
      tpsvcinfo.setAction_name("com.chb.coses.eplatonFMK.business.delegate.action.CashCardBizAction");
      tpsvcinfo.setOperation_name("com.chb.coses.eplatonFMK.othersystem.operation.COMMO1000");
      ...
      switch( resevent.getTPSVCINFODTO().getErrorcode().charAt(0) )
      {
        ...
        case 'I':
          resevent = (EPlatonEvent)tpcsendrecv.callEJB("CashCard",
              "CashCardBizAction",
              "com.chb.coses.eplatonFMK.othersystem.operation.COMMO1000",
              event);
          break;
      }
